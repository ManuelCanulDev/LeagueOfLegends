    ...
    <section class="page-section portfolio mt-5" id="portfolio">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <h4>Add Hability of <?php echo $champion['name']; ?></h4>
                    <form method="post" id="upload_form" enctype="multipart/form-data">
                        ...
                        <input name="id_champion" type="hidden" value="<?php echo $champion['id']; ?>">
                        <br>
        ...
        $(document).ready(function () {
            $('#upload_form').on('submit', function (e) {
                ...
                if ($('#name').val() == '' || $('#image').val() == '') {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>api/v1/habilities/add",
                        ...
                        success: function (data) {
                            if (data['message'] == 'OK') {
                                alert('Habilidad de <?php echo $champion['name']; ?> Agregad@');
                                if (confirm('Desea agregar otra habilidad para <?php echo $champion['name']; ?>?')) {
                                    // Save it!
                                    window.location.href = "<?php echo base_url('add-hability/'.$id_champion); ?>";
                                } else {
                                    // Do nothing!
